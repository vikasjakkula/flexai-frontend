-- Create analytics tables for test performance tracking
-- This migration creates tables for time tracking and analytics
...
-- Function to update updated_at timestamp for attempt_question_times
