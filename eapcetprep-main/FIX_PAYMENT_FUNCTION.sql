-- Fix handle_successful_payment function to match new signature
-- This drops all old versions and creates the new one with 2 parameters
...
-- Create the new function with 2 parameters (order_id and payment_id)
-- It automatically handles affiliate detection and premium_until calculation
