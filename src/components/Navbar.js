...
function Navbar() {
  ...
  return (
    <GoogleOAuthProvider clientId="1000901593505-8807f9dt0os7m27f9850iptqn7bf304v.apps.googleusercontent.com">
      <nav className={`navbar fixed-navbar w-full flex items-center justify-between px-4 md:px-8 py-4 ${theme}`}
        ...
        {/* Google Login/Profile - right corner */}
        <div className="ml-auto flex items-center gap-2">
          ...
          {user && (
            <div className="flex items-center gap-2 bg-white rounded shadow px-3 py-1">
              ...
              <button onClick={handleLogout} className="ml-2 px-2 py-1 text-xs bg-red-500 text-white rounded">Logout</button>
            </div>
          )}
        </div>
